...
.PHONY: setup format format-check lint typecheck test-unit test-integration test-e2e content-validate test check services services-down migrate seed api-generate api-contract-check build dev-api dev-web
...
content-validate:
	$(PYTHON) python scripts/validate_content.py
